(() => {
    ...
    const listPay = document.querySelectorAll(".body-pay__btn");
    listPay.forEach((btn => {
        btn.addEventListener("click", (e => {
            listPay.forEach((btn => {
                btn.classList.remove("body-pay__btn--active");
            }));
            e.target.classList.add("body-pay__btn--active");
            e.preventDefault();
        }));
    }));
    ...
    const btnToTop = document.querySelector(".footer__button");
